...
labels = ["Quota #", "Day #", "Quota Value", "Daily Average", "Quota Average", "Ship Scrap"]
fileNames = ["QuotaNumber.txt", "DayNumber.txt", "QuotaValue.txt", "DailyAverage.txt", "QuotaAverage.txt", "ShipScrap.txt"]
entries = []
